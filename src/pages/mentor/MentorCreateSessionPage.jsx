...
import { FiPlus,FiArrowLeft, FiCalendar, FiClock, FiUsers, FiUpload, FiX } from 'react-icons/fi';

const MentorCreateSessionPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!sessionData.thumbnail) newErrors.thumbnail = 'Thumbnail is required';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="bg-gradient-to-r from-teal-500 to-teal-700 px-6 py-8 sm:py-12 sm:px-10">
            ...
            <p className="mt-2 text-teal-100">Fill in the details to schedule your live session</p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                {sessionData.thumbnailPreview ? (
                  ...
                  <div className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 ${errors.thumbnail ? 'border-red-300' : 'border-gray-300'} border-dashed rounded-md`}>
...
export default MentorCreateSessionPage;