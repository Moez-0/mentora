          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              <Link to="/" className="flex items-center">
                <img className="h-8 w-auto" src="/logo.svg" alt="Mentora" />

              </Link>
              <p className="text-gray-300 text-base">
                Empowering your learning journey with expert-led courses and interactive experiences.
              </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul className="mt-4 space-y-4">
                    <li>
                      <a href="mailto:hello@mentora.com" className="text-base text-gray-400 hover:text-white">
                        Email Us
                      </a>
                    </li>
                    <li>
                      <a href="tel:+21696154061" className="text-base text-gray-400 hover:text-white">
                        +216 96154061
                      </a>
                    </li>
                    <li>
